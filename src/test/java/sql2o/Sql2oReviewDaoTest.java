...
//    private static ReviewHelper reviewDao; //these variables are now static.
//
//    @BeforeClass
...
//
//    @Test
//    public void getAllReviewsByKid() throws Exception {
//        Tour testTour = setupTour();
...
//        assertEquals(0, reviewDao.getAllReviewsByKid(testTour.getId()).size());
//    }
//
//    @Test
...
//
//        assertEquals(4, reviewDao.getAllReviewsByKid(testTour.getId()).size()); //it is important we verify that the list is the same size.
//        assertEquals(4, reviewDao.getAllReviewsByKidSortedNewestToOldest(testTour.getId()).get(0).getContent());
//    }
//
//    //helpers
//
